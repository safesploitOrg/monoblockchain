...
class Blockchain:
    ...
    def hash(block):
        """
        Dictionary must be ordered, else inconsistent hashes
        """
    ...
    def resolve_conflicts(self):
        """
        Used to resolve conflicts between other nodes in the blockchain,
        by comparing/synchronising nodes chain length
        """
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--port', default=5001, help="Port to listen to")  # default node
